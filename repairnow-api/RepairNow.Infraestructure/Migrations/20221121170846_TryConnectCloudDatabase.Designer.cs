...
namespace RepairNow.Infraestructure.Migrations
{
    ...
    [Migration("20221121170846_TryConnectCloudDatabase")]
    partial class TryConnectCloudDatabase
    {
            ...
            modelBuilder.Entity("RepairNow.Infraestructure.Appliance", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2022, 11, 21, 12, 8, 45, 921, DateTimeKind.Local).AddTicks(824));
            ...
            modelBuilder.Entity("RepairNow.Infraestructure.Appointment", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 11, 21, 12, 8, 45, 921, DateTimeKind.Local).AddTicks(270));
            ...
            modelBuilder.Entity("RepairNow.Infraestructure.Report", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 11, 21, 12, 8, 45, 920, DateTimeKind.Local).AddTicks(9712));
            ...
            modelBuilder.Entity("RepairNow.Infraestructure.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 11, 21, 12, 8, 45, 920, DateTimeKind.Local).AddTicks(8914));
