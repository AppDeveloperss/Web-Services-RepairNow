...
namespace RepairNow.Infraestructure.Migrations
{
    ...
    [Migration("20221114225144_Initial5")]
            ...
            modelBuilder.Entity("RepairNow.Infraestructure.Appliance", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2022, 11, 14, 17, 51, 44, 97, DateTimeKind.Local).AddTicks(907));
            ...
            modelBuilder.Entity("RepairNow.Infraestructure.Appointment", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 11, 14, 17, 51, 44, 97, DateTimeKind.Local).AddTicks(271));
            ...
            modelBuilder.Entity("RepairNow.Infraestructure.Report", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 11, 14, 17, 51, 44, 96, DateTimeKind.Local).AddTicks(9642));
            ...
            modelBuilder.Entity("RepairNow.Infraestructure.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 11, 14, 17, 51, 44, 96, DateTimeKind.Local).AddTicks(8895));
